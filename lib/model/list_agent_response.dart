...
//
//     final listAgentsResponse = listAgentsResponseFromJson(jsonString);

import 'dart:convert';

ListAgentsResponse listAgentsResponseFromJson(String str) => ListAgentsResponse.fromJson(json.decode(str));

String listAgentsResponseToJson(ListAgentsResponse data) => json.encode(data.toJson());
...
class ListAgentsResponse {
    ...
    factory ListAgentsResponse.fromJson(Map<String, dynamic> json) => ListAgentsResponse(
        status: json["status"],
